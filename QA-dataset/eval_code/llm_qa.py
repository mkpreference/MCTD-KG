...
OUTPUT_FILE = "/root/files_lpz/ra/实验/literature/qa_dataset/qa_ans/pure_llm_eval_results.json" 
# =========================================================================
...
def run_pure_llm_experiment():
    ...
    for idx, item in enumerate(dataset):
        ...
        print(f"[进度: {idx+1}/{total_questions}] [题型: {strategy}]")
        print(f"  问题: {question}")
    ...
    print("="*50)
    print(f"🏆 Pure LLM 评测结束! 最终准确率: {accuracy*100:.1f}% ({correct_count}/{total_questions})")
